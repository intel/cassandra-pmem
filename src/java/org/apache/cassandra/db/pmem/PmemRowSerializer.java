...
public class PmemRowSerializer extends UnfilteredSerializer
{
 ...
 */
    ...
    public static final org.apache.cassandra.db.pmem.PmemRowSerializer serializer = new org.apache.cassandra.db.pmem.PmemRowSerializer();

    /*
     * Unfiltered flags constants.
     */
    private final static int HAS_VERSION          = 0x01; // Repurposed this flag in UnfilteredSerializer to store version
    ...
    throws IOException
    {
        ...
        if(version > 1)
        {
            out.writeByte(1); //TODO: need to write proper size
    ...
    throws IOException
    {
        try
        {
           ...
           // Columns columns =  Columns.serializer.deserializeSubset(headerColumns, in);
   ...
   /* private static boolean isExtended(int flags)
    ...
    public static boolean isTableAltered(int flags)
    {
        return (flags & HAS_VERSION) != 0;
    }
